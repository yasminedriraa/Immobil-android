...
public class TinyDB {
      ...
      public void putListItemToSell(String key, List<itemToSell> playerList){
            checkForNullKey(key);
            Gson gson = new Gson();
            ArrayList<String> objStrings = new ArrayList<String>();
            for(itemToSell player: playerList){
      ...
      public List<itemToSell> getItemToSell(String key){
            Gson gson = new Gson();

            ArrayList<String> objStrings = getListString(key);
            ArrayList<itemToSell> playerList = new ArrayList<>();

            for(String jObjString : objStrings){
                  itemToSell player  = gson.fromJson(jObjString,  itemToSell.class);
