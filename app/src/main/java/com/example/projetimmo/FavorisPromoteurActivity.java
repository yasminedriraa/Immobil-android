...
public class FavorisPromoteurActivity extends AppCompatActivity {
    private static final String TAG = "FavorisPromoteurActivity" ;
    private Context context = FavorisPromoteurActivity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_favoris_promoteur);
        back = findViewById(R.id.back);
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(FavorisPromoteurActivity.this,DashbordActivity.class);
                startActivity(i);
            }
        });
        //recyclerview
...
//        RecyclerViewAdapterFavoris myAdapter = new RecyclerViewAdapterFavoris(this, annonces);
